...
const QuoteCard = ({ quote, index }) => (
  <motion.div
    ...
    whileHover={{ y: -4 }}
    className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 flex flex-col shadow-sm hover:shadow-md transition-shadow duration-300"
  >
    <BsFillChatQuoteFill className="w-6 h-6 sm:w-8 sm:h-8 text-primary/30 mb-2 sm:mb-3 flex-shrink-0" />

    <p className="font-apple text-xs sm:text-base leading-relaxed mb-3 sm:mb-6 text-gray-800">
      {quote.Quote}
    </p>
    ...
    <div className="flex items-center gap-2.5 sm:gap-3 mt-auto">
      <img
        src={quote.image}
        alt={quote.name}
        className="w-10 h-10 sm:w-14 sm:h-14 rounded-full object-cover shadow-sm flex-shrink-0"
        loading="lazy"
      />
      <div>
...
const Quotes = () => {
  ...
  return (
    <section id="testimonial" className="bg-[#f7f8fc] py-10 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-4xl font-bold font-title mb-2 sm:mb-4">
            Fuel Your Mind with Gentle Wisdom
          </h2>
          <p className="text-gray-600 text-xs sm:text-base md:text-lg md:w-1/2 mx-auto leading-relaxed">
